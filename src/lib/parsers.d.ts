 ...
 * @returns {boolean}
 */
declare const asBoolean: <C extends HTMLElement>(_: C, value: string | null) => boolean;
/**
 ...
 */
declare const asInteger: (fallback?: number) => <C extends HTMLElement>(_: C, value: string | null) => number;
/**
 ...
 * @returns {(host: C, value: string | null) => number} - parser function
 */
declare const asNumber: (fallback?: number) => <C extends HTMLElement>(_: C, value: string | null) => number;
/**
 ...
 */
declare const asString: (fallback?: string) => <C extends HTMLElement>(_: C, value: string | null) => string;
/**
 ...
 * @returns {(host: C, value: string | null) => string} - parser function
 */
declare const asEnum: (valid: [string, ...string[]]) => <C extends HTMLElement>(_: C, value: string | null) => string;
/**
 ...
 */
declare const asJSON: <T extends {}>(fallback: T) => <C extends HTMLElement>(_: C, value: string | null) => T;
