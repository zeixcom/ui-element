...
type SignalLike<T, P extends ComponentProps> = (string & keyof P) | Signal<NonNullable<T>> | (<E extends Element>(target: E, index: number) => T);
 ...
 */
declare const insertNode: <E extends Element, P extends ComponentProps>(s: SignalLike<boolean, P>, { type, where, create }: NodeInserter<P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const setText: <E extends Element, P extends ComponentProps>(s: SignalLike<string, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const setAttribute: <E extends Element, P extends ComponentProps>(name: string, s?: SignalLike<string, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const toggleAttribute: <E extends Element, P extends ComponentProps>(name: string, s?: SignalLike<boolean, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const toggleClass: <E extends Element, P extends ComponentProps>(token: string, s?: SignalLike<boolean, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const setStyle: <E extends (HTMLElement | SVGElement | MathMLElement), P extends ComponentProps>(prop: string, s?: SignalLike<string, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const dangerouslySetInnerHTML: <E extends Element, P extends ComponentProps>(s: SignalLike<string, P>, attachShadow?: "open" | "closed", allowScripts?: boolean) => (host: Component<P>, target: E, index?: number) => (() => void)[];
/**
 ...
 */
declare const insertTemplate: <P extends ComponentProps>(template: HTMLTemplateElement, s: SignalLike<boolean, P>, where?: InsertPosition) => (host: Component<P>, target: Element, index?: number) => (() => void)[];
/**
 ...
 */
declare const createElement: <P extends ComponentProps>(tag: string, s: SignalLike<boolean, P>, where?: InsertPosition, attributes?: Record<string, string>, text?: string) => (host: Component<P>, target: Element, index?: number) => (() => void)[];
/**
 ...
 */
declare const removeElement: <E extends Element, P extends ComponentProps>(s: SignalLike<boolean, P>) => (host: Component<P>, target: E, index?: number) => (() => void)[];
