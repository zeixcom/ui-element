 ...
 */
declare const updateElement: <E extends Element, T extends {}, P extends ComponentProps = {}, K extends keyof P = never>(s: K | SignalLike<T>, updater: ElementUpdater<E, P[K] | T>) => (host: HTMLElement & P, target: E, index: number) => void;
/**
 * Effect to insert a node relative to an element according to a given SignalLike
 */
declare const insertNode: <E extends Element, P extends ComponentProps = {}, K extends keyof P = never>(s: K | SignalLike<boolean>, { type, where, create }: NodeInserter<P>) => (host: HTMLElement & P, target: E, index: number) => void;
/**
 ...
 */
declare const setText: <E extends Element>(s: SignalLike<string>) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const setProperty: <E extends Element, K extends keyof E>(key: K, s?: SignalLike<E[K]>) => (host: HTMLElement & ComponentProps, target: E, index: number) => void;
/**
 ...
 */
declare const setAttribute: <E extends Element>(name: string, s?: SignalLike<string>) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const toggleAttribute: <E extends Element>(name: string, s?: SignalLike<boolean>) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const toggleClass: <E extends Element>(token: string, s?: SignalLike<boolean>) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const setStyle: <E extends (HTMLElement | SVGElement | MathMLElement)>(prop: string, s?: SignalLike<string>) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const dangerouslySetInnerHTML: <E extends Element>(s: SignalLike<string>, attachShadow?: "open" | "closed", allowScripts?: boolean) => (host: HTMLElement, target: E, index: number) => void;
/**
 ...
 */
declare const insertTemplate: <P extends ComponentProps>(template: HTMLTemplateElement, s: SignalLike<boolean>, where?: InsertPosition) => (host: HTMLElement & P, target: Element, index: number) => void;
/**
 ...
 */
declare const createElement: (tag: string, s: SignalLike<boolean>, where?: InsertPosition, attributes?: Record<string, string>, text?: string) => (host: HTMLElement, target: Element, index: number) => void;
/**
 ...
 */
declare const removeElement: <E extends Element, P extends ComponentProps>(s: SignalLike<boolean>) => (host: HTMLElement & P, target: E, index: number) => void;
