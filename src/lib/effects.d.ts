import { type BaseUIElement } from '../ui-element';
 ...
 */
declare const updateElement: <E extends Element, T>(s: StateKeyOrFunction<T>, updater: ElementUpdater<E, T>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const createElement: (tag: string, s: StateKeyOrFunction<Record<string, string>>) => (host: BaseUIElement, target: Element) => void;
/**
 ...
 */
declare const removeElement: <E extends Element>(s: StateKeyOrFunction<boolean>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const setText: <E extends Element>(s: StateKeyOrFunction<string>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const setProperty: <E extends Element>(key: string, s?: StateKeyOrFunction<unknown>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const setAttribute: <E extends Element>(name: string, s?: StateKeyOrFunction<string>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const toggleAttribute: <E extends Element>(name: string, s?: StateKeyOrFunction<boolean>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const toggleClass: <E extends Element>(token: string, s?: StateKeyOrFunction<boolean>) => (host: BaseUIElement, target: E) => void;
/**
 ...
 */
declare const setStyle: <E extends (HTMLElement | SVGElement | MathMLElement)>(prop: string, s?: StateKeyOrFunction<string>) => (host: BaseUIElement, target: E) => void;
