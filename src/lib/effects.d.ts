...
type SignalLike<P extends ComponentProps, T, E extends Element = HTMLElement> = keyof P | Signal<NonNullable<T>> | ((element: E) => T | null | undefined);
 ...
 */
declare const updateElement: <P extends ComponentProps, T extends {}, E extends Element = HTMLElement>(s: SignalLike<P, T, E>, updater: ElementUpdater<E, T>) => FxFunction<P, E>;
/**
 ...
 */
declare const insertOrRemoveElement: <P extends ComponentProps, E extends Element = HTMLElement>(s: SignalLike<P, number, E>, inserter?: ElementInserter<E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setText: <P extends ComponentProps, E extends Element = HTMLElement>(s: SignalLike<P, string, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setAttribute: <P extends ComponentProps, E extends Element = HTMLElement>(name: string, s?: SignalLike<P, string, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const toggleAttribute: <P extends ComponentProps, E extends Element = HTMLElement>(name: string, s?: SignalLike<P, boolean, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const toggleClass: <P extends ComponentProps, E extends Element = HTMLElement>(token: string, s?: SignalLike<P, boolean, E>) => FxFunction<P, E>;
/**
