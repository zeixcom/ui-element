...
import { type ComponentProps, type Component, type FxFunction } from '../component';
type SignalLike<P extends ComponentProps, T, E extends Element = Component<P>> = keyof P | Signal<NonNullable<T>> | ((element: E) => T | null | undefined);
 ...
 */
declare const updateElement: <P extends ComponentProps, T extends {}, E extends Element = Component<P>>(s: SignalLike<P, T, E>, updater: ElementUpdater<E, T>) => FxFunction<P, E>;
/**
 ...
 */
declare const insertOrRemoveElement: <P extends ComponentProps, E extends Element = Component<P>>(s: SignalLike<P, number, E>, inserter?: ElementInserter<E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setText: <P extends ComponentProps, E extends Element = Component<P>>(s: SignalLike<P, string, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setProperty: <P extends ComponentProps, K extends keyof E, E extends Element = Component<P>>(key: K, s?: SignalLike<P, E[K], E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setAttribute: <P extends ComponentProps, E extends Element = Component<P>>(name: string, s?: SignalLike<P, string, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const toggleAttribute: <P extends ComponentProps, E extends Element = Component<P>>(name: string, s?: SignalLike<P, boolean, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const toggleClass: <P extends ComponentProps, E extends Element = Component<P>>(token: string, s?: SignalLike<P, boolean, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const setStyle: <P extends ComponentProps, E extends HTMLElement | SVGElement | MathMLElement>(prop: string, s?: SignalLike<P, string, E>) => FxFunction<P, E>;
/**
 ...
 */
declare const dangerouslySetInnerHTML: <P extends ComponentProps, E extends Element>(s: SignalLike<P, string, E>, attachShadow?: "open" | "closed", allowScripts?: boolean) => FxFunction<P, E>;
