...
export { type AttributeParser, type ComponentProps, type SignalInitializer, type EventListenerProvider, RESET, component, first, all, pass, on, emit } from './src/component';
