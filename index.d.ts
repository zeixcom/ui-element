...
export { type ElementFromSelector, type StringParser, type ValueOrExtractor, fromComponent, fromDOM, fromSelector, read, reduced, requireElement, } from './src/core/dom';
