...
[@zeix/el-truco](../globals.md) / StoreChangeEvent

# Interface: StoreChangeEvent\<T\>

Defined in: node\_modules/@zeix/cause-effect/types/src/store.d.ts:45
...
Defined in: node\_modules/@zeix/cause-effect/types/src/store.d.ts:47
...
Defined in: node\_modules/@zeix/cause-effect/types/src/store.d.ts:46
