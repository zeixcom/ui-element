...
[@zeix/el-truco](../globals.md) / StoreAddEvent

# Interface: StoreAddEvent\<T\>

Defined in: node\_modules/@zeix/cause-effect/types/src/store.d.ts:41
...
Defined in: node\_modules/@zeix/cause-effect/types/src/store.d.ts:43
