 ...
 */
declare const asInteger: <E extends Element = HTMLElement>(fallback?: Fallback<number, E>) => Parser<number, E>;
/**
 ...
 * @returns {Parser<number, E>} Parser function
 */
declare const asNumber: <E extends Element = HTMLElement>(fallback?: Fallback<number, E>) => Parser<number, E>;
/**
 ...
 */
declare const asString: <E extends Element = HTMLElement>(fallback?: Fallback<string, E>) => Parser<string, E>;
/**
 ...
 */
declare const asJSON: <T extends {}, E extends Element = HTMLElement>(fallback: Fallback<T, E>) => Parser<T, E>;
