...
type SignalProducer<T extends {}, C extends HTMLElement = HTMLElement> = Extractor<MaybeSignal<T>, C>;
type MethodProducer<C extends HTMLElement> = (host: C) => void;
type Initializer<T extends {}, C extends HTMLElement> = T | Parser<T, C> | SignalProducer<T, C> | MethodProducer<C>;
...
export { type Component, type ComponentProps, type ReservedWords, type ValidPropertyKey, type ValidateComponentProps, type Initializer, type SignalProducer, type MethodProducer, type Setup, component, };
